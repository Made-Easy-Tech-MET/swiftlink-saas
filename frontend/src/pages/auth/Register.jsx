...
const translations = {
  en: {
    ...
    subtitle: 'Join SwiftLink and start managing your delivery operations',
    fullName: 'Full Name',
    ...
    panelTitle: 'Join the Delivery Revolution',
    panelText: 'Connect with restaurants and customers. Deliver meals, earn money, and build your reputation.',
    pwdMismatch: 'Passwords do not match',
    pwdShort: 'Password must be at least 6 characters',
    failed: 'Failed to sign up'
  },
  fr: {
    create: 'Creer votre compte',
    subtitle: 'Rejoignez SwiftLink et demarrez vos operations de livraison',
    ...
    already: 'Deja un compte ?',
    signIn: 'Se connecter',
    social: 'Connexion sociale',
    comingSoon: 'Tres bientot',
    panelTitle: 'Rejoignez la revolution de la livraison',
    panelText: 'Connectez-vous aux restaurants et clients. Livrez, gagnez et developpez votre reputation.',
    pwdMismatch: 'Les mots de passe ne correspondent pas',
    pwdShort: 'Le mot de passe doit contenir au moins 6 caracteres',
...
export default function Register() {
  ...
  const handleSubmit = async (e) => {
    ...
    if (result.success) {
      navigate(result.dashboardRoute || getDashboardRoute())
    } else {
